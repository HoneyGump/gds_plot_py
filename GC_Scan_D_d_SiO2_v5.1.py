###############################
'''
the radius of hole is reduced 10 nm
'''
import numpy as np
import gdspy
...
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.155, 0.690, 'UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.705, 'UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
D = temp['D']*1e6
d = temp['d_goal']*1e6 
posi_end = GC.Scan_d_Apod(lib, GC_scan, D-0.01, d, 'AGC_SiO2', step=0.005, offset_scan=-0.020, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
posi_end = GC.Scan_D_Apod(lib, GC_scan, D-0.01, d, 'AGC_SiO2', step=0.005, offset_scan=0.015, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs, D_max=0.18)
...
posi_end = GC.Scan_trench(lib, GC_scan, para, 'AGC_SiO2', step=0.005, offset_scan=0, origin=posi_end, n=(4,2), space=200, type_GC='FA', **kwargs)
posi_end = GC.Scan_tooth(lib, GC_scan, para, 'AGC_SiO2', step=0.005, offset_scan=0, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.155, 0.665, '2UGC_SiO2', step=0.003, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.680, '2UGC_SiO2', step=0.003, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
D = temp['D']*1e6
d = temp['d_goal']*1e6 
posi_end = GC.Scan_d_Apod(lib, GC_scan, D-0.01, d, '2AGC_SiO2', step=0.003, offset_scan=-0.020, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
posi_end = GC.Scan_D_Apod(lib, GC_scan, D-0.01, d, '2AGC_SiO2', step=0.003, offset_scan=0.025, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
filename = './data_apodized/apod_2D_params_SiO2_8Deg.txt'
para = GC.readParameters(filename)
posi_end = GC.Scan_trench(lib, GC_scan, para, '2AGC_SiO2', step=0.003, offset_scan=0.020, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
posi_end = GC.Scan_tooth(lib, GC_scan, para, '2AGC_SiO2', step=0.003, offset_scan=-0.022, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.155, 0.690, '3UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.705, '3UGC_SiO2_', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
for D_index in range(D.shape[0]):
    ...
    if D[D_index,0] >= 0.180:
        D2[D_index,0] = 0.180
d = temp['d_goal']*1e6 
posi_end = GC.Scan_d_Apod(lib, GC_scan, D-0.01, d, '3AGC_SiO2', step=0.005, offset_scan=-0.020, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
#####################################################################################################################vvv
# line
posi_end = (2600, -4800)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.155, 0.665, '4UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.68, '4UGC_SiO2_', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
for D_index in range(D.shape[0]):
    ...
    if D[D_index,0] >= 0.180:
        D2[D_index,0] = 0.180
d = temp['d_goal']*1e6 
posi_end = GC.Scan_D_Apod(lib, GC_scan, D-0.01, d, '4AGC_SiO2', step=0.005, offset_scan=0.010, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
##
...
# add GC_FA for MZMs
cell_GC = lib.cells['AGC_SiO2_D10']
...
DEVICES.add(ref)
lib.write_gds('GC_MZM_SiO2_v5.1.gds')