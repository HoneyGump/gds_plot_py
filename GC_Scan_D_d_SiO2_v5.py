###############################
'''
the diameter of hole is reduced 10 nm
'''
import numpy as np
import gdspy
...
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.680, 'UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.175, 0.695, 'UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.655, '2UGC_SiO2', step=0.003, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.175, 0.670, '2UGC_SiO2', step=0.003, origin=posi_end, n=(3,3), space=200, type_GC='FA', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.680, '3UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.175, 0.695, '3UGC_SiO2_', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.165, 0.655, '4UGC_SiO2', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
ref = gdspy.CellReference(com)
GC_scan.add(ref)
posi_end = GC.Scan_d(lib, GC_scan, 0.175, 0.67, '4UGC_SiO2_', step=0.005, origin=posi_end, n=(3,3), space=200, type_GC='line', **kwargs)
...
DEVICES.add(ref)
lib.write_gds('GC_MZM_SiO2_v5.gds')