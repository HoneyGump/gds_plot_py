...
l_taper_a = 510 # length of grating start taper for output
l_taper_b = 100 # length of grating end taper for output
l_wg = 100 # length of waveguides
...
D_all= np.linspace(165, 180, 4)*1e-3
d_goal_all = np.linspace(670,710,9)*1e-3
...
device = lib.new_cell('GC_Deg10_x5_SiO2')
